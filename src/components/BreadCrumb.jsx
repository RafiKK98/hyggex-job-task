            ...
            <ul className="flex items-center">
                ...
                <li>
                    <a className="flex items-center">
                        ...
                        <span className="text-lg font-medium text-[#696671]">Mathematics</span>
                    </a>
                </li> 
                <li>
                    <a className="flex items-center">
